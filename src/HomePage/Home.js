...
const Home = () => {
    ...
    async function replaceScreens() {
        ...
        let tempCurrent = data[p1 - 1].current
        let tempPath = data[p1 - 1].path
    ...
    return (
        <div style={{width: '80%', margin: 'auto'}}>
            ...
            <div class="screen_images">
                <div class="s1"><img src="images/screen1.png" alt="" id="1"></img></div>
                <div class="s2"><img src="images/screen2.png" alt="" id="2"></img></div>
                <div class="s9"><img src="images/screen9.png" alt="" id="9"></img></div>
                <div class="s3"><img src="images/screen3.png" alt="" id="3"></img></div>
                <div class="s4"><img src="images/screen4.png" alt="" id="4"></img></div>
                <div class="s10"><img src="images/screen10.png" alt="" id="10"></img></div>
                <div class="s5"><img src="images/screen5.png" alt="" id="5"></img></div>
                <div class="s6"><img src="images/screen6.png" alt="" id="6"></img></div>
                <div class="s11"><img src="images/screen11.png" alt="" id="11"></img></div>
                <div class="s7"><img src="images/screen7.png" alt="" id="7"></img></div>
                <div class="s8"><img src="images/screen8.png" alt="" id="8"></img></div>
            </div>
            ...
            <input type='text' value={p1} name='p1' onChange={(x) => {
                setp1(x.target.value)
            }} placeholder='number 1'/>
            <label>Screen Number 2</label>
            <input type='text' value={p2} name='p2' onChange={(x) => {
